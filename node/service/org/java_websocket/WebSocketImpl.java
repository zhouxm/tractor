...
/**
 * Represents one end (cn.jj.ai.tractor.client or cn.jj.ai.tractor.server) of a single WebSocketImpl connection.
 * Takes care of the "handshake" phase, then allows for easy sending of
 * text frames, and receiving frames through an event-based cn.jj.ai.tractor.model.
 */
public class WebSocketImpl implements WebSocket {
    ...
    /**
     * Queue of buffers that need to be sent to the cn.jj.ai.tractor.client.
     */
    ...
    /**
     * crates a websocket with cn.jj.ai.tractor.server role
     */
    ...
    /**
     * crates a websocket with cn.jj.ai.tractor.client role
     *
    ...
    public void startHandshake(ClientHandshakeBuilder handshakedata) throws InvalidHandshakeException {
        ...
        try {
            ...
            // Stop if the cn.jj.ai.tractor.client code throws an exception
            throw new InvalidHandshakeException("Handshake data rejected by cn.jj.ai.tractor.client.");
        } catch (RuntimeException e) {
            wsl.onWebsocketError(this, e);
