 ...
 * useful. At runtime the user is expected to establish a connection via {@link #connect()}, then receive events like {@link #onMessage(String)} via the overloaded methods and to {@link #send(String)} data to the cn.jj.ai.tractor.server.
 */
public abstract class WebSocketClient extends WebSocketAdapter implements Runnable, WebSocket {
    ...
    /**
     * Sends <var>text</var> to the connected websocket cn.jj.ai.tractor.server.
     *
    ...
    /**
     * Sends binary <var> data</var> to the connected webSocket cn.jj.ai.tractor.server.
     *
     * @param data The byte-Array of data to send to the WebSocket cn.jj.ai.tractor.server.
     */
