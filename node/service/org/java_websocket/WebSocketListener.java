...
public interface WebSocketListener {
    ...
    /**
     * Called on the cn.jj.ai.tractor.server side when the socket connection is first established, and the WebSocket
     ...
     * @param draft   The protocol draft the cn.jj.ai.tractor.client uses to connect
     * @param request The opening http message send by the cn.jj.ai.tractor.client. Can be used to access additional fields like cookies.
    ...
    /**
     * Called on the cn.jj.ai.tractor.client side when the socket connection is first established, and the WebSocketImpl
     * handshake response has been received.
     *
     * @param conn     The WebSocket related to this event
     * @param request  The handshake initially send out to the cn.jj.ai.tractor.server by this websocket.
     * @param response The handshake the cn.jj.ai.tractor.server sent in response to the request.
     * @throws InvalidDataException Allows the cn.jj.ai.tractor.client to reject the connection with the cn.jj.ai.tractor.server in respect of its handshake response.
     */
     ...
     *
     * @param conn    The WebSocket related to this event
     * @param request The handshake sent to the cn.jj.ai.tractor.server by this websocket
     * @throws InvalidDataException Allows the cn.jj.ai.tractor.client to stop the connection from progressing
     */
     ...
     *           Might be null if the exception is not related to any specific connection. For example if the cn.jj.ai.tractor.server port could not be bound.
     */
    ...
    /**
     * Gets the XML string that should be returned if a cn.jj.ai.tractor.client requests a Flash
     * security policy.
     *
