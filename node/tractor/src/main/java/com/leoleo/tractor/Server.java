...
public class Server extends WebSocketServer {
    ...
    public Server(InetSocketAddress addr, String viewserverAddr, String myAddr, String masterKey) {
        super(addr);
...
//        String port = args[1].split(":")[1];
        Server s = new Server(new InetSocketAddress(Integer.parseInt("3003")),
                "0.0.0.0",
                "0.0.0.0:3003",
                "");
        s.start();
