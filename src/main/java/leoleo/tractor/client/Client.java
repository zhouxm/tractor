...
import leoleo.tractor.view.View;
...
public class Client {
    ...
    /**
     * Connects to the cn.jj.ai.tractor.server at the specified port and address.
     *
     * @throws IOException
     */
    ...
    /* Called after a response from the cn.jj.ai.tractor.server */
